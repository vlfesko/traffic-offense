        ...
        <div class="row">
            <div class="col-6">
                <div class="form-group">
                    <label class="control-label" for="date_created">Date Violated</label>
            ...
            <div class="col-6">
                <div class="form-group">
                    <label class="control-label" for="officer_id">Officer ID.</label>
                    <input type="text" class="form-control" name="officer_id" id="officer_id" value="<?php echo isset($officer_id) ? $officer_id : '' ?>" required>
                </div>
                <div class="form-group">
                    <label class="control-label" for="officer_name">Officer Name.</label>
